...
struct Z_Construct_UFunction_AComfyStreamActor_ClearAllSpawnedObjects_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
...
// ********** Begin Class AComfyStreamActor Function ConnectRGBAChannel ****************************
struct Z_Construct_UFunction_AComfyStreamActor_ConnectRGBAChannel_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "ComfyStream" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AComfyStreamActor_ConnectRGBAChannel_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AComfyStreamActor, nullptr, "ConnectRGBAChannel", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AComfyStreamActor_ConnectRGBAChannel_Statics::Function_MetaDataParams), Z_Construct_UFunction_AComfyStreamActor_ConnectRGBAChannel_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UFunction_AComfyStreamActor_ConnectRGBAChannel()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AComfyStreamActor_ConnectRGBAChannel_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AComfyStreamActor::execConnectRGBAChannel)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ConnectRGBAChannel();
	P_NATIVE_END;
}
// ********** End Class AComfyStreamActor Function ConnectRGBAChannel ******************************
...
void AComfyStreamActor::StaticRegisterNativesAComfyStreamActor()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "ConnectRGBAChannel", &AComfyStreamActor::execConnectRGBAChannel },
...
struct Z_Construct_UClass_AComfyStreamActor_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bEnable3DReconstruction_MetaData[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Enable 3D reconstruction mode (spawn separate meshes per object)\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Enable 3D reconstruction mode (spawn separate meshes per object)" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bUpdateOnMaskOnly_MetaData[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Only update reconstruction when mask changes (prevents clearing on every texture update)\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Only update reconstruction when mask changes (prevents clearing on every texture update)" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bAccumulateObjects_MetaData[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Accumulate objects instead of clearing them (add new objects to scene)\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Accumulate objects instead of clearing them (add new objects to scene)" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DepthScale_MetaData[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Depth scale factor (how far objects are placed based on depth)\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Depth scale factor (how far objects are placed based on depth)" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ObjectScale_MetaData[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Scale factor for spawned objects\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Scale factor for spawned objects" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bSpawnSingleObject_MetaData[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Spawn one object per mask update (simple mode) vs segment by color\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Spawn one object per mask update (simple mode) vs segment by color" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MinObjectSize_MetaData[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Minimum object size in pixels to spawn a mesh (only used if segmenting by color)\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Minimum object size in pixels to spawn a mesh (only used if segmenting by color)" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ColorTolerance_MetaData[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Color tolerance for mask segmentation (higher = fewer objects, groups similar colors)\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Color tolerance for mask segmentation (higher = fewer objects, groups similar colors)" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ObjectMesh_MetaData[] = {
		{ "Category", "ComfyStream|3D Reconstruction" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Mesh to use for spawned objects (defaults to plane)\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Mesh to use for spawned objects (defaults to plane)" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RGBAChannelConfig_MetaData[] = {
		{ "Category", "ComfyStream" },
#if !UE_BUILD_SHIPPING
	...
	static void NewProp_bEnable3DReconstruction_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bEnable3DReconstruction;
	static void NewProp_bUpdateOnMaskOnly_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bUpdateOnMaskOnly;
	static void NewProp_bAccumulateObjects_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bAccumulateObjects;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_DepthScale;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_ObjectScale;
	static void NewProp_bSpawnSingleObject_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bSpawnSingleObject;
	static const UECodeGen_Private::FIntPropertyParams NewProp_MinObjectSize;
	static const UECodeGen_Private::FIntPropertyParams NewProp_ColorTolerance;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ObjectMesh;
	static const UECodeGen_Private::FStructPropertyParams NewProp_RGBAChannelConfig;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AComfyStreamActor_ClearAllSpawnedObjects, "ClearAllSpawnedObjects" }, // 1735526327
		...
		{ &Z_Construct_UFunction_AComfyStreamActor_ConnectRGBAChannel, "ConnectRGBAChannel" }, // 3915743387
...
void Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bEnable3DReconstruction_SetBit(void* Obj)
{
	((AComfyStreamActor*)Obj)->bEnable3DReconstruction = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bEnable3DReconstruction = { "bEnable3DReconstruction", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AComfyStreamActor), &Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bEnable3DReconstruction_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bEnable3DReconstruction_MetaData), NewProp_bEnable3DReconstruction_MetaData) };
void Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bUpdateOnMaskOnly_SetBit(void* Obj)
{
	((AComfyStreamActor*)Obj)->bUpdateOnMaskOnly = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bUpdateOnMaskOnly = { "bUpdateOnMaskOnly", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AComfyStreamActor), &Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bUpdateOnMaskOnly_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bUpdateOnMaskOnly_MetaData), NewProp_bUpdateOnMaskOnly_MetaData) };
void Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bAccumulateObjects_SetBit(void* Obj)
{
	((AComfyStreamActor*)Obj)->bAccumulateObjects = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bAccumulateObjects = { "bAccumulateObjects", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AComfyStreamActor), &Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bAccumulateObjects_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bAccumulateObjects_MetaData), NewProp_bAccumulateObjects_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_DepthScale = { "DepthScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AComfyStreamActor, DepthScale), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DepthScale_MetaData), NewProp_DepthScale_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_ObjectScale = { "ObjectScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AComfyStreamActor, ObjectScale), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ObjectScale_MetaData), NewProp_ObjectScale_MetaData) };
void Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bSpawnSingleObject_SetBit(void* Obj)
{
	((AComfyStreamActor*)Obj)->bSpawnSingleObject = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bSpawnSingleObject = { "bSpawnSingleObject", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AComfyStreamActor), &Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bSpawnSingleObject_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bSpawnSingleObject_MetaData), NewProp_bSpawnSingleObject_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_MinObjectSize = { "MinObjectSize", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AComfyStreamActor, MinObjectSize), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MinObjectSize_MetaData), NewProp_MinObjectSize_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_ColorTolerance = { "ColorTolerance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AComfyStreamActor, ColorTolerance), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ColorTolerance_MetaData), NewProp_ColorTolerance_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_ObjectMesh = { "ObjectMesh", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AComfyStreamActor, ObjectMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ObjectMesh_MetaData), NewProp_ObjectMesh_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_RGBAChannelConfig = { "RGBAChannelConfig", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AComfyStreamActor, RGBAChannelConfig), Z_Construct_UScriptStruct_FComfyStreamConfig, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RGBAChannelConfig_MetaData), NewProp_RGBAChannelConfig_MetaData) }; // 249633148
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_DepthChannelConfig = { "DepthChannelConfig", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AComfyStreamActor, DepthChannelConfig), Z_Construct_UScriptStruct_FComfyStreamConfig, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DepthChannelConfig_MetaData), NewProp_DepthChannelConfig_MetaData) }; // 249633148
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_MaskChannelConfig = { "MaskChannelConfig", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AComfyStreamActor, MaskChannelConfig), Z_Construct_UScriptStruct_FComfyStreamConfig, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaskChannelConfig_MetaData), NewProp_MaskChannelConfig_MetaData) }; // 249633148
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AComfyStreamActor_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bEnable3DReconstruction,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bUpdateOnMaskOnly,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bAccumulateObjects,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_DepthScale,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_ObjectScale,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_bSpawnSingleObject,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_MinObjectSize,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_ColorTolerance,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_ObjectMesh,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComfyStreamActor_Statics::NewProp_RGBAChannelConfig,
...
struct Z_CompiledInDeferFile_FID_Users_alexi_OneDrive_Documents_Unreal_Projects_Reconstruction_3D_Plugins_ComfyStream_Source_ComfyStream_Public_ComfyStreamActor_h__Script_ComfyStream_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AComfyStreamActor, AComfyStreamActor::StaticClass, TEXT("AComfyStreamActor"), &Z_Registration_Info_UClass_AComfyStreamActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AComfyStreamActor), 2923694341U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_alexi_OneDrive_Documents_Unreal_Projects_Reconstruction_3D_Plugins_ComfyStream_Source_ComfyStream_Public_ComfyStreamActor_h__Script_ComfyStream_649661642(TEXT("/Script/ComfyStream"),
