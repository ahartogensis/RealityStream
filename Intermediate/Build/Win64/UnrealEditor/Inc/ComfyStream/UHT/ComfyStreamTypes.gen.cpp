...
COMFYSTREAM_API UScriptStruct* Z_Construct_UScriptStruct_FComfyLerpState();
...
struct Z_Construct_UScriptStruct_FComfyStreamConfig_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_LerpSpeed_MetaData[] = {
		...
		{ "ClampMin", "0.01" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Lerp speed for smooth transitions (higher = faster, 0-1 typical range)\n" },
#endif
		{ "ModuleRelativePath", "Public/ComfyStreamTypes.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Lerp speed for smooth transitions (higher = faster, 0-1 typical range)" },
#endif
	};
...
class UScriptStruct* FComfyLerpState::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FComfyLerpState.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FComfyLerpState, (UObject*)Z_Construct_UPackage__Script_ComfyStream(), TEXT("ComfyLerpState"));
	}
...
struct Z_CompiledInDeferFile_FID_Users_alexi_OneDrive_Documents_Unreal_Projects_Reconstruction_3D_Plugins_ComfyStream_Source_ComfyStream_Public_ComfyStreamTypes_h__Script_ComfyStream_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FComfyStreamConfig::StaticStruct, Z_Construct_UScriptStruct_FComfyStreamConfig_Statics::NewStructOps, TEXT("ComfyStreamConfig"), &Z_Registration_Info_UScriptStruct_FComfyStreamConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FComfyStreamConfig), 631194733U) },
